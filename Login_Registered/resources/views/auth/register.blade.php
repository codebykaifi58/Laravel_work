    ...
    <div id="form-back">
        <form id="form" method="POST" action="{{ route('register') }}">
                ...
                <div id="name-back">
                    ...
                    <x-text-input id="name" class="block mt-1 w-full" type="text" placeholder="Name..." name="name" :value="old('name')" required autofocus autocomplete="name" />
                    <x-input-error :messages="$errors->get('name')" class="mt-2" />
                </div>

                <!-- Email Address -->
                <div id="email-back" class="mt-4">
                ...
                <!-- Password -->
                <div id="password-back" class="mt-4">
                ...
                <!-- Confirm Password -->
                <div id="conf_password" class="mt-4">
